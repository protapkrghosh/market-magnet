import { FaBuffer,FaRegStar,FaRegCheckCircle  } from "react-icons/fa";
export  const banners =[
    {
        title:"Agency for\n outdoor \nadvertising.",
        img:"https://outmedia.freekytheme.com/wp-content/uploads/2023/08/slider-image3.jpg",
       
    },
    {
        title:"Build Your\nBrand image\nwith us",
        img:"https://outmedia.freekytheme.com/wp-content/uploads/2023/08/slider-image1.jpg",
       
    },
    {
        title:"Builds brand\nawareness\nimmediately",
        img:"https://outmedia.freekytheme.com/wp-content/uploads/2023/08/main-slider-3.jpg",
    ...
    export const video = [
      {
        ...
        para: "Billboards capture repeat exposure business message more effectively than almost any other marketing channel..",
      },
      {
        icon: <FaRegStar />,
        heading: "SMARTLY PLANNED",
        para: "Start building your brand with the strategic one. an industry that your brand with the strategic one industry expertise.        ",
      },
      {
